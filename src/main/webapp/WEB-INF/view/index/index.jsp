...
<body>
	...
	<div class="container-fluid">
		<div class="row" style="height: 34px; background-color: #222222">
			<a href="#"><font color="#FFFFFF" size="3px">下载APP &nbsp</font></a>
			<div style="left: -8px">
			...
			<div class="col-md-2" style="height: 550px">
				...
				<ul class="list-group">
					...
					<c:forEach items="${channels}" var="c">
						...
						<li class="channel-item ${c.id==article.channelId?"active":"" }" >
						<a href="?channelId=${c.id }">${c.name } </a></li>
	...
	<script type="text/javascript">
		function goPage(page) {
			...
			location.href = "?channelId="channelId"'&categoryId="+categoryId+"&page="+ page;
